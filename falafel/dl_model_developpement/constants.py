...
TRAIN_BOOL = 0   # 1 if you want to train the model, 0 otherwise
...
DATABASE_DIR_ZIP = "data/cats_and_dogs_filtered.zip"                                # Defines location of import of database zip file
